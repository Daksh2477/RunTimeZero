...
**Training data is generated by our own twin, and that is defensible here** — we need labelled crash
events and labelled fraud, which no public dataset contains and no real operator would hand over.
