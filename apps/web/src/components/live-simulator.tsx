...
export function LiveSimulator({ initial, pondLabel, siteName }: Props) {
  ...
  /* One sidebar panel open at a time, at every screen size: the pond and the
   * control you are turning have to be visible together, and two open panels
   * pushed the totals off a laptop screen. 'settings' starts open because
   * changing something is why anyone opens this page. */
  const [openPanel, setOpenPanel] = useState<string | null>('settings');

  return <div className="sim-workspace is-framed">
