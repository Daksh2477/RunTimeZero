//#region node_modules/.nitro/vite/services/ssr/assets/mockData-CPGb_Aq0.js
var SITES = [{
	id: "SITE-01",
	name: "Kutch Coastal Array",
	region: "Gujarat, IN",
	activePonds: 12,
	biomassTonnes: 41.6,
	creditsIssued: 1840
...
var PONDS = [
	...
	},
	{
		...
		biomassGPerL: .51,
		lastSyncMinutes: 12,
		note: "Heat stress — flush advised"
	}
];
var CREDIT_BATCHES = [
	{
		...
		siteId: "SITE-01",
		tonnesCO2: 120,
		pricePerTonneUsd: 31.5,
		verificationHash: "0x7ac1…9f42",
	...
	},
	{
		...
		siteId: "SITE-02",
		tonnesCO2: 85,
		pricePerTonneUsd: 29.9,
		verificationHash: "0x21be…c034",
	...
	},
	{
		...
		siteId: "SITE-01",
		tonnesCO2: 64,
		pricePerTonneUsd: 28.4,
		verificationHash: "0x9d70…41aa",
...
function bandFor(value, warn, critical) {
...
//#endregion
export { GROWTH_OUTLOOK as a, SITES as c, bandFor as d, statusToken as f, FORECAST_24H as i, USERS as l, EARNED_CREDITS as n, PONDS as o, FIELD_RISKS as r, ROLE_META as s, CREDIT_BATCHES as t, WEATHER_NOW as u };
