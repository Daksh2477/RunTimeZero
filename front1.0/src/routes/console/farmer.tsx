        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline" size="sm" className="gap-2">
              <Plus className="size-4" /> Add Pond
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Register a new algae pond to your farm. It will begin syncing telemetry immediately.
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                <Label htmlFor="pondName">Pond Name or ID</Label>
                <Input id="pondName" placeholder="e.g. Pond Alpha" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="pondLocation">Location / Zone</Label>
                <Input id="pondLocation" placeholder="e.g. North Sector" />
              </div>
            </div>
            <div className="flex justify-end gap-3">
              <Button type="button">Register Pond</Button>
            </div>
          </DialogContent>
        </Dialog>
      </div>
