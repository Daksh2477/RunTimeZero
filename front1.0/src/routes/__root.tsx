  ...
  head: () => ({
    meta: [
      ...
      { title: "RunTimeZero — AlgaCarbon" },
      {
        name: "description",
        content:
          "Microalgae telemetry, growth simulation and verified carbon credit trading for farmers, investors and researchers.",
      },
      { property: "og:title", content: "RunTimeZero — AlgaCarbon" },
      {
